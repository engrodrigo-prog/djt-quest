...
"""${safeDescription}"""`;
        ...
        if (!resp.ok) {
            ...
            return res.status(200).json({
                ...
                meta: {
                    usedAI: false,
                    reason: `openai_error: ${txt || resp.status}`,
                },
            });
        }
        const data = await resp.json().catch(() => null);
        const content = (data === null || data === void 0 ? void 0 : data.choices[0].message.content) || '';
        let json;
        try {
        ...
        if (!(json === null || json === void 0 ? void 0 : json.title) || !(json === null || json === void 0 ? void 0 : json.description)) {
            return res.status(200).json({
                cleaned: {
                    title: safeTitle.trim(),
                    description: safeDescription.trim(),
