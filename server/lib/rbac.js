export { ROLE, ROLE_ALIASES, normalizeRole, rolesToSet, hasRole, isAdmin, isLeaderRole, canCurate, canSeeAnswerKey, studioLandingPath, STUDIO_ALLOWED_ROLES } from '../../shared/rbac.js';

import { ROLE, normalizeRole, rolesToSet, hasRole, isAdmin, isLeaderRole, canCurate, canAssignRoles } from '../../shared/rbac.js';
