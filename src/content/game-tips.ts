...
export const gameTips: Record<string, GameTip> = {
  ...
  'studio-finance': {
    ...
    body: [
      ...
      '• Exportar relatório (XLSX) com os filtros atuais.',
      '',
      'Como funciona para o usuário:',
      '• Reembolso: adicione 1+ itens, cada um com valor e comprovante (PDF/JPG/PNG).',
      '• Adiantamento: adicione 1+ motivos; valor é opcional e não há anexos.',
      '',
      'Boas práticas:',
