...
export const gameTips: Record<string, GameTip> = {
  'studio-curation': {
    ...
    body: [
      ...
      '• Publicar para todos: quando as perguntas e alternativas estiverem validadas, o quiz já vai direto ao público.',
      '• Revisão (opcional): curadoria pode ajustar qualidade, linguagem e contexto quando necessário.',
      '',
  ...
  'xp-overview': {
    ...
    body: [
      ...
      '',
      '• SEPBook:',
      '  - +30 XP por publicação.',
      '  - +5 XP por foto incluída na publicação.',
      '  - +5 XP por comentário.',
      '  - +1 XP por curtida.',
      '',
      '• Quizzes:',
      ...
      '',
      '• Avaliações (líderes):',
      '  - +5 XP por avaliação concluída.',
      '',
      '• Eventos & Iniciativas:',
      '  - Ações registradas e avaliadas podem converter pontos em XP, conforme configurado pela área de gestão.',
      '',
      'Essas regras podem ser ajustadas ao longo do tempo. Consulte seu líder ou o Studio para entender campanhas e bônus ativos.'
    ].join('\n'),
  },
};
